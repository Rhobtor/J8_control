...
#include "car_interfaces/msg/detail/graph__rosidl_typesupport_fastrtps_c.h"
...
#include "geometry_msgs/msg/detail/pose_array__functions.h"  // nodes
#include "rosidl_runtime_c/primitives_sequence.h"  // edges
#include "rosidl_runtime_c/primitives_sequence_functions.h"  // edges
...
using _Graph__ros_msg_type = car_interfaces__msg__Graph;
  ...
  void * untyped_ros_message)
{
  ...
  // Field name: edges
  {
    ...
    if (ros_message->edges.data) {
      rosidl_runtime_c__int32__Sequence__fini(&ros_message->edges);
    }
    if (!rosidl_runtime_c__int32__Sequence__init(&ros_message->edges, size)) {
...
size_t get_serialized_size_car_interfaces__msg__Graph(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _Graph__ros_msg_type * ros_message = static_cast<const _Graph__ros_msg_type *>(untyped_ros_message);
...
static uint32_t _Graph__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_car_interfaces__msg__Graph(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_car_interfaces
size_t max_serialized_size_car_interfaces__msg__Graph(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = car_interfaces__msg__Graph;
    is_plain =
      (
...
static size_t _Graph__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_car_interfaces__msg__Graph(
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, car_interfaces, msg, Graph)() {
