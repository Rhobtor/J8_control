...
#include "car_interfaces/msg/detail/graph__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const car_interfaces::msg::Graph & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  car_interfaces::msg::Graph & ros_message)
{
  // Member: nodes
  ...
  size_t current_alignment)
{
  ...
  // Member: edges
  {
    ...
    size_t item_size = sizeof(ros_message.edges[0]);
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = car_interfaces::msg::Graph;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const car_interfaces::msg::Graph *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<car_interfaces::msg::Graph *>(
    untyped_ros_message);
...
get_message_type_support_handle<car_interfaces::msg::Graph>()
{
  return &car_interfaces::msg::typesupport_fastrtps_cpp::_Graph__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, car_interfaces, msg, Graph)() {
  return &car_interfaces::msg::typesupport_fastrtps_cpp::_Graph__handle;
}
