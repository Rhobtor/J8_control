...
#include "hector_gazebo_plugins/srv/detail/set_bias__rosidl_typesupport_fastrtps_cpp.hpp"
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = hector_gazebo_plugins::srv::SetBias_Request;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const hector_gazebo_plugins::srv::SetBias_Request *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<hector_gazebo_plugins::srv::SetBias_Request *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _SetBias_Request__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const hector_gazebo_plugins::srv::SetBias_Request *>(
...
static size_t _SetBias_Request__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_SetBias_Request(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _SetBias_Request__callbacks = {
...
static rosidl_message_type_support_t _SetBias_Request__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_SetBias_Request__callbacks,
...
{
  return &hector_gazebo_plugins::srv::typesupport_fastrtps_cpp::_SetBias_Request__handle;
}
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = hector_gazebo_plugins::srv::SetBias_Response;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const hector_gazebo_plugins::srv::SetBias_Response *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<hector_gazebo_plugins::srv::SetBias_Response *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _SetBias_Response__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const hector_gazebo_plugins::srv::SetBias_Response *>(
...
static size_t _SetBias_Response__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_SetBias_Response(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _SetBias_Response__callbacks = {
  "hector_gazebo_plugins::srv",
  "SetBias_Response",
...
static rosidl_message_type_support_t _SetBias_Response__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_SetBias_Response__callbacks,
  get_message_typesupport_handle_function,
};
...
{
  return &hector_gazebo_plugins::srv::typesupport_fastrtps_cpp::_SetBias_Response__handle;
}
...
static service_type_support_callbacks_t _SetBias__callbacks = {
  "hector_gazebo_plugins::srv",
  "SetBias",
  ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, hector_gazebo_plugins, srv, SetBias_Request)(),
  ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, hector_gazebo_plugins, srv, SetBias_Response)(),
...
static rosidl_service_type_support_t _SetBias__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_SetBias__callbacks,
...
{
  return &hector_gazebo_plugins::srv::typesupport_fastrtps_cpp::_SetBias__handle;
}
